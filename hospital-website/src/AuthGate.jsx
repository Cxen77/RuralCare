    ...
    <div className="login-shell">
      <form className="login-card" onSubmit={submit}>
        <div className="login-brand">
          ...
          <div>
            <h1 className="login-title">RuralCare Hospital</h1>
            <p className="login-subtitle">Sign in to manage referrals, beds and ambulances</p>
          </div>
        </div>
        ...
        <div className="login-field">
          ...
          <input
            ...
            placeholder="hospital@ruralcare.dev"
          />
        </div>
...
export function AuthGate({ children }) {
  ...
  useEffect(() => {
    ...
    // failure must not sign the staff out mid-shift.
    session
      .me()
