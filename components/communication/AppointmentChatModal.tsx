 ...
 * Real-time chat between Patient and Doctor for a specific appointment.
...
interface AppointmentChatModalProps {
  ...
  mode?: string;
  /** Must provide an API-like object with getAppointmentMessages & sendAppointmentMessage */
  api: {
                  ...
                  <View key={msg.id} style={[styles.msgRow, isMe ? styles.msgRowMe : styles.msgRowOther]}>
                    {!isMe && (
                      <View style={styles.avatarCircle}>
                        <MaterialIcons
                          name={msg.senderRole === 'DOCTOR' ? 'medical-services' : 'person'}
                          size={14}
