...
const TRANSITIONS = {
  ...
  ambulance: {
    available: ['requested', 'assigned', 'dispatched', 'en_route', 'maintenance', 'returning'],
    requested: ['assigned', 'available', 'dispatched'],
    assigned: ['dispatched', 'available'],
    dispatched: ['en_route', 'arrived', 'transporting', 'at_hospital', 'returning', 'available', 'maintenance'],
    en_route: ['arrived', 'transporting', 'at_hospital', 'returning', 'available', 'dispatched'],
    arrived: ['transporting', 'at_hospital', 'returning', 'available'],
    transporting: ['at_hospital', 'returning', 'available'],
    at_hospital: ['returning', 'available', 'dispatched'],
    returning: ['available', 'maintenance', 'dispatched'],
