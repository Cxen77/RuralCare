    ...
    >
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        <View style={styles.brand}>
          ...
          <Text style={styles.subtitle}>Sign in to reach doctors, medicines and hospitals</Text>
        </View>
        ...
        <Card style={styles.card}>
          <Input
            ...
            placeholder="patient@ruralcare.dev"
        ...
        <Text style={styles.endpoint}>Connected to {API_BASE_URL}</Text>
      </ScrollView>
    </KeyboardAvoidingView>
  );
};
